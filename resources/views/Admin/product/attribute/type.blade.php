        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Loại sản phẩm</h6>
        ...
        <div class="col">
            <div class="card" id='card_table'>
                ...
                <div class="card-header border-0" id='header_table' onclick="tb_theme()">
                    <h3 class="mb-0" id='table_header_name'>Danh sách lọai sản phẩm</h3>
                </div>
                <script>
                    function tb_theme() {
                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush" id='table_Theme'>
                        <thead class="___class_+?23___" id='thead_Theme'>
                            <tr>
                                <th scope="col" class="sort col-3" data-sort="name">Loại sản phẩm</th>
...
<!-- Modal -->
@include('Admin.product.attribute.addType')
@include('Admin.product.attribute.updateType')
...
<script type="text/javascript">
    ...
    $('#form-add').submit(function(e) {
        ...
        $.ajax({
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                toastr.options.positionClass = 'toast-bottom-left'
                toastr.error('Thêm loại sản phẩm thất bại', 'Thất bại 👺👹👺')
            }
        })
    })
    ...
    function editWh(id) {
        $.get('type/' + id, function(e) {
            $('#id').val(id);
            $('#type-edit').val(e.name);
    ...
    $("#form-edit").submit(function(e) {
        ...
        if (type !== '') {
            $.ajax({
                ...
                error: function(res) {
                    toastr.options.positionClass = 'toast-bottom-left'
                    toastr.error('Cập nhật loại sản phẩm thất bại', 'Thất bại 👺👹👺')
                }
            })
        }
    });
